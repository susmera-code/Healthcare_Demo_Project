  ...
  return (
    <div className="container">
      ...
      <div className="mb-3 text-end">
        <button
          className="btn btn-primary me-2 fs-14 fw-semibold"
          onClick={() => setShowModal(true)}
        >Add Availability</button>

        <button
          className="btn btn-secondary fs-14 fw-semibold"
                ...
                <table className="table table-bordered mb-0">
                  <thead className="table-primary">
                    <tr>
                      ...
                      <th className="text-blue">To</th>
                      <th className="text-blue">Location</th>
                      <th className="text-blue">Payment Status</th>
                  ...
                  <tbody>
                    {pastAppointments.length === 0 ? (
                      <tr>
                        <td colSpan="6" className="text-center">No past appointments</td>
                      </tr>
                    ) : (
