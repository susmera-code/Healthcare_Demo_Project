...
function Home() {
    ...
    return (
        <div>
            {/* ================= HERO SECTION ================= */}
            <div className="overflow-hidden mb-4 position-relative">
                <div className="row g-0 align-items-stretch min-vh-50">

                    {/* Left */}
                    <div className="col-md-7 d-flex align-items-center px-5 py-5 bg-blue position-relative">
                        <div>
                            ...
                            <div className="row text-muted small fs-15 text-start">
                                ...
                                <div className="col-6 mt-1"><i className="bi bi-check-circle-fill"></i> Flexible Slots</div>
                                <div className="col-6 mt-1"><i className="bi bi-check-circle-fill"></i> Support & Escalation</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card shadow-sm rounded-4 p-4 d-flex align-items-center">
                            <div className="d-flex align-items-start gap-3">
                                ...
                                <div className="d-flex flex-column">
                                    ...
                                    <ul className="list-unstyled mb-3 text-muted fa-15">
                        ...
                        <div className="card shadow-sm rounded-4 p-4">
                            <div className="d-flex align-items-start gap-3 text-muted">
                                ...
                                <div className="d-flex flex-column text-start">
                                    <h5 className="fw-bold mb-1 text-blue fs-23">A Personal Turning Point</h5>
                                    <p>
                    ...
                    <div className="col-md-6">
                        <div className="card shadow-sm rounded-4 p-4 ">
                            <div className="d-flex align-items-start gap-3">
                                <img src={Subaa_Logo} alt="Logo" className="logo" style={{ height: "8rem", padding: "0" }} />
                                <div className="d-flex flex-column text-start">
                                    <h5 className="fw-bold mb-1 text-blue fs-23">A Gap That Needed Attention</h5>
                                    <span className="text-muted">During this journey, it became evident that:</span>
                                    <ul className="list-unstyled mb-3 text-muted fa-15">
                        ...
                        <div className="card shadow-sm rounded-4 p-4 h-100">
                            <div className="d-flex align-items-start gap-3">
                                ...
                                <img
                                    src={verifiedIcon}
                                    alt="Home healthcare"
                                    style={{ width: '98px', objectFit: 'cover' }}
                                />
                                <div className="d-flex flex-column text-start">
                        ...
                        <div className="card shadow-sm rounded-4 p-4 h-100">
                            <div className="d-flex align-items-start gap-3">
                                <img
                                    src={noteIcon}
                                    alt="Transparancy"
                                    style={{ width: '123px', height: '95px', objectFit: 'cover' }}
                                />
                                <div className="d-flex flex-column text-start">
